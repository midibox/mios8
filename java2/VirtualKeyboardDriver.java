...
public class VirtualKeyboardDriver extends JApplet {
	...
	public static void main(String[] args) {
		...
		final VirtualKeyboardDriver virtualKeyboardGUIDriver = new VirtualKeyboardDriver();
