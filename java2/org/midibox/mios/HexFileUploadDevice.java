/*
 * @(#)HexFileUploadDevice.java	beta8	2006/04/23
 *
...
public class HexFileUploadDevice extends VirtualMidiDevice {

	protected HexFileUpload hexFileUpload;

	public HexFileUploadDevice(String name) {
		super(name, -1, -1);
		this.hexFileUpload = new HexFileUpload(midiOutPort);
	}
	...
	protected void receiveFromReceivers(MidiMessage message, long timestamp) {
		hexFileUpload.send(message, timestamp);
	}
}
