...
public class MidiMonitorFilteredDevice extends VirtualMidiDevice {
	...
	protected MidiMonitorFiltered midiFilteredPortMonitor;

	public MidiMonitorFilteredDevice(String name) {
		super(name, 0, -1);
		midiFilteredPortMonitor = new MidiMonitorFiltered();
	}

	public MidiMonitorFiltered getMidiFilteredPortMonitor() {
		return midiFilteredPortMonitor;
	}

	protected void receiveFromReceivers(MidiMessage message, long timestamp) {
		midiFilteredPortMonitor.send(message, timestamp);
	}
}
