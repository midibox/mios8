...
USER_DISPLAY_Cont
	...
	TABLE_ADDR STR_BUTTON_CR
	call	MIOS_LCD_PrintString

	movlw	0x45
	call	MIOS_LCD_CursorSet
	incf	SM_BUTTON_COLUMN, W
	call	MIOS_LCD_PrintBCD2
			
	movlw	0x4e
	call	MIOS_LCD_CursorSet
	incf	SM_BUTTON_ROW, W
	call	MIOS_LCD_PrintBCD1
		
	return

STR_BUTTON_DEPRESSED STRING 16, 0x00, "Button Depressed"
STR_BUTTON_PRESSED   STRING 16, 0x00, "Button Pressed  "

STR_BUTTON_CR        STRING 16, 0x40, "Col:     Row:   "
