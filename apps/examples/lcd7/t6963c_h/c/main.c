 ...
 * 
 * please find the LCD driver in $MIOS_PATH/modules/app_lcd/t6963c_h/app_lcd.asm
 *
 * ==========================================================================
 *
...
{
  // select LCD type #7
  // (custom LCD driver, hooks in $MIOS_PATH/modules/app_lcd/t6963c_h/app_lcd.asm module will be used)
...
void DISPLAY_Init(void) __wparam
{
  ...
  MIOS_LCD_PrintCString("            T6963C horizontal           ");

  MIOS_GLCD_GCursorSet(  4, 2);
  MIOS_LCD_PrintCString("      ---> low performance!!! <---      ");
