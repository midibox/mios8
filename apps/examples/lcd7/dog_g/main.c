...
void DISPLAY_Init(void) __wparam
{
  ...
  MIOS_GLCD_GCursorSet(  30, 0);
  MIOS_LCD_PrintCString("**EA-DOGL**");

  MIOS_GLCD_GCursorSet(  30, 1); 
  MIOS_LCD_PrintCString("<-Fastest->");

  MIOS_GLCD_GCursorSet( 35, 4);
  ...
  MIOS_GLCD_GCursorSet(  1, 0);
  MIOS_LCD_PrintChar(0x01); // icon #01
  MIOS_GLCD_GCursorSet(  1, 5);
  MIOS_LCD_PrintChar(0x07); // icon #07
  MIOS_GLCD_GCursorSet(128-28, 0);
  MIOS_LCD_PrintChar(0x05); // icon #05
  MIOS_GLCD_GCursorSet(128-28, 5);
