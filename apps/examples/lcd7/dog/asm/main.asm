...
;; ---[ Custom LCD driver ]---
#include <app_lcd.inc>		; located in $MIOS_PATH/modules/app_lcd/dog
...
TEXT_WELCOME_0	STRING 16, 0x00, " EA DOGM163x-A  "
TEXT_WELCOME_1	STRING 16, 0x40, "Powered by MIOS!"
TEXT_WELCOME_2	STRING 16, 0x50, " Third line :-) "
