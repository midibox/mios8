...
;
; please find the LCD driver in $MIOS_PATH/modules/app_lcd/ks0108/app_lcd.inc
;
; ==========================================================================
;
...
;; ---[ Custom LCD driver ]---
#include <app_lcd.inc>		; located in $MIOS_PATH/modules/app_lcd/ks0108
...
GLCD_DemoScreen
	...
	;; -----------   X   Y len   string
TEXT_WELCOME_0	db	 4,  1, 40, "           KS0108 horizontal            "
TEXT_WELCOME_1	db	 4,  2, 40, "     ---> best performance!!! <---      "
