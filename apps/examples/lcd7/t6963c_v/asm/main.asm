...
;
; please find the LCD driver in $MIOS_PATH/modules/app_lcd/t6963c_v/app_lcd.inc
;
; ==========================================================================
;
...
;; ---[ Custom LCD driver ]---
#include <app_lcd.inc>		; located in $MIOS_PATH/modules/app_lcd/t6963c_v
...
GLCD_DemoScreen
	...
	TABLE_ADDR TEXT_WELCOME_0		; T6963C
	rcall	USER_LCD_PrintXString
	TABLE_ADDR TEXT_WELCOME_1		; vertical
	rcall	USER_LCD_PrintXString

	TABLE_ADDR TEXT_WELCOME_2		; Custom
	rcall	USER_LCD_PrintXString
	TABLE_ADDR TEXT_WELCOME_3		; LCD
	rcall	USER_LCD_PrintXString
	TABLE_ADDR TEXT_WELCOME_4		; Driver
	rcall	USER_LCD_PrintXString

	TABLE_ADDR TEXT_WELCOME_5		; powered
	rcall	USER_LCD_PrintXString
	TABLE_ADDR TEXT_WELCOME_6		; by
	rcall	USER_LCD_PrintXString

	TABLE_ADDR GLCD_FONT_BIG		;; use big font
	call	MIOS_GLCD_FontInit

	TABLE_ADDR TEXT_WELCOME_7		; MIOS
	rcall	USER_LCD_PrintXString

	TABLE_ADDR GLCD_FONT_KNOB_ICONS		;; use knobs icons
	call	MIOS_GLCD_FontInit

	TABLE_ADDR TEXT_WELCOME_8		; 2 knobs
	rcall	USER_LCD_PrintXString
	TABLE_ADDR TEXT_WELCOME_9		; 2 knobs
	rcall	USER_LCD_PrintXString
	...
	;; -----------   X   Y len   string
TEXT_WELCOME_0	db	 2,  2, 10, "  T6963C  "
TEXT_WELCOME_1	db	 2,  4, 10, "!vertical!"

TEXT_WELCOME_2	db	 2, 10, 10, "  Custom  "
TEXT_WELCOME_3	db	 5, 11, 10, "   LCD    "
TEXT_WELCOME_4	db	 2, 12, 10, "  Driver  "

TEXT_WELCOME_5	db	 5, 14, 10, " powered  "
TEXT_WELCOME_6	db	 2, 15, 10, "    by    "
TEXT_WELCOME_7	db	 0, 16,  4, "MIOS"

TEXT_WELCOME_8	db	 5, 21,  2, 1, 5
TEXT_WELCOME_9	db	 5, 24,  2, 7, 10
