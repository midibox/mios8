 ...
 * 
 * please find the LCD driver in $MIOS_PATH/modules/app_lcd/clcd/app_lcd.asm
 *
 * ==========================================================================
 *
...
{
  // select LCD type #7
  // (custom LCD driver, hooks in $MIOS_PATH/modules/app_lcd/clcd/app_lcd.asm module will be used)
