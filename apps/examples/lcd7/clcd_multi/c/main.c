 ...
 * 
 * please find the LCD driver in $MIOS_PATH/modules/app_lcd/clcd_multi/app_lcd.asm
 *
 * ==========================================================================
 *
...
extern void USER_LCD_Select(unsigned char sel);
...
{
  // select LCD type #7
  // (custom LCD driver, hooks in $MIOS_PATH/modules/app_lcd/clcd_multi/app_lcd.asm module will be used)
