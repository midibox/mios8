// $Id$
/*
 * This demo application overwrites .syx files by new content
 * All values != 0xf0 and != 0xf7 will be incremented
 *
 * While for real world applications this function is totally useless, it
 * nicely demonstrates the approach to overwrite file contents.
 *
 * ==========================================================================
 *
...
unsigned char SysEx_Overwriter(unsigned char *syx_filename) __wparam;
...
/////////////////////////////////////////////////////////////////////////////
// This function overwrites the all blocks of given .syx file
// (all numbers != 0xf0 and != f7 will be incremented)
...
__endasm;
    ...
    // increment all numbers != 0xf0 and != 0xf7
    write_offset = 0;
...
__endasm;
  ...
  MIOS_LCD_CursorSet(0x40);
  MIOS_LCD_PrintCString("File Modified!  ");
