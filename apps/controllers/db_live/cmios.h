...
extern void MIOS_CLCD_SpecialCharInit(code char *c_table) __wparam;
...
extern void MIOS_Delay(void) __wparam;
...
extern void MIOS_IIC_ByteSend(unsigned char b) __wparam;
