...
// export the tables
extern const unsigned char mm_dio_table_layer0[2*128];
extern const unsigned char mm_dio_table_layer1[2*128];
...
#define ID_MBMM_TOGGLE_LAYER	0x92	// like a "caps lock" key
#define ID_MBMM_HOLD_LAYER	0x93	// like a common "shift" key

#define ID_MBMM_SWITCH_MM	0x94	// switch to Motormix Emulation (like radiobutton)
#define ID_MBMM_SWITCH_GPC	0x95	// switch to General Purpose Controller mode (like radiobutton)
#define ID_MBMM_TOGGLE_GPC	0x96	// like a "caps lock" key
#define ID_MBMM_HOLD_GPC	0x97	// like a common "shift" key
