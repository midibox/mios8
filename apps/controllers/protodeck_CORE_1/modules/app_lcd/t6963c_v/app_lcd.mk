...
GPASM_INCLUDE += -I $(MIOS_PATH)/modules/app_lcd/t6963c_v

# make rule for relocatable version
$(OUTDIR)/app_lcd.o: $(MIOS_PATH)/modules/app_lcd/t6963c_v/app_lcd.asm
	$(GPASM) $(GPASM_FLAGS) $(GPASM_INCLUDE) $(GPASM_DEFINES) $(APP_LCD_DEFINES) $< -o $@

# directories and files that should be part of the distribution (release) package
DIST += $(MIOS_PATH)/modules/app_lcd/t6963c_v
