...
const unsigned char	scaleNames[SCALE_MAX][4] = {
	...
	{ "MAJ" },	// Major				1
	{ "min" },	// Natural Minor		2
	{ "hrm" },	// Harmonic Minor		3
	{ "blu" },	// Blues Minor			4
	{ "BLU" },	// Blues Major			5
	{ "DOR" },	// Dorian				6
	{ "JAP" },	// Japanese				7
	{ "jap" },	// Japanese Diminshed	8
	{ "KUM" },	// Kumoi				9
	{ "LOC" },	// Locrian				10
	{ "LYD" },	// Lydian				11
	{ "MIS" },	// Mi-Sheberach			12
	{ "MIX" },	// Mixolydian			13
	{ "PLG" },	// Pelog				14
	{ "PNT" },	// Pentatonic Neutral	15
	{ "PBL" },	// Pentatonic Blues		16
	{ "PMA" },	// Pentatonic Major		17
	{ "pmi" },	// Pentatonic Minor		18
	{ "PRY" },	// Phrygian				19
	{ "SPA" }	// Spanish				20
};
...
void ACHarmonizer_SetBase(unsigned char value) __wparam {
	// sets new base note
	unsigned char c;
	for(c=0;c<127;c++) {
		if(value < 12) { 
...
void ACHarmonizer_SetScale(unsigned char value) __wparam {
...
void ACHarmonizer_ToggleScale(unsigned char direction) __wparam {
	// 0:down, 1:up
	if(direction) {
		// switch to next scale
		harmonizer_scale++;
...
unsigned char ACHarmonize(unsigned char value) __wparam {
