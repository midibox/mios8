 ...
 *	v0.0.4	12.06.09	added General Remote Message & extended for 16 sensors/channels
 *
 *
 *	description:
 *		MIDI Definition Listing for AC-Applications
...
#define	ACMIDICTRLPROTOCOL_VERSION				0x04
...
#define MIDI_CC_SENSOR_A						20	// 0x14	// 1
#define MIDI_CC_SENSOR_B						21	// 0x15	// 2
#define MIDI_CC_SENSOR_C						22	// 0x16	// 3
#define MIDI_CC_SENSOR_D						23	// 0x17	// 4

#define MIDI_CC_SENSOR_E						24	// 0x18	// 5
#define MIDI_CC_SENSOR_F						25	// 0x19	// 6
#define MIDI_CC_SENSOR_G						26	// 0x20	// 7
#define MIDI_CC_SENSOR_H						27	// 0x21	// 8

#define MIDI_CC_SENSOR_I						28	// 0x22	// 9
#define MIDI_CC_SENSOR_J						29	// 0x23	// 10
#define MIDI_CC_SENSOR_K						30	// 0x24	// 11
#define MIDI_CC_SENSOR_L						31	// 0x25	// 12

#define MIDI_CC_SENSOR_M						32	// 0x26	// 13
#define MIDI_CC_SENSOR_N						33	// 0x27	// 14
#define MIDI_CC_SENSOR_O						34	// 0x28	// 15
#define MIDI_CC_SENSOR_P						35	// 0x29	// 16
...
// ** General Remote **
#ifdef _DEBUG_C
	#pragma mark General Remote
#endif

#define MIDI_CC_GENERAL_REMOTE					119	// byte3 has the keyCode (0..127)
