...
include $(MIOS_PATH)/modules/app_lcd/clcd_multi_8/app_lcd.mk
---
  ...
  4) CLCDs can be selected with USER_LCD_Select(<number>);  // number 0..7
     see also the example application under $MIOS_PATH/apps/examples/lcd7/clcd_multi_8
...
~~~~~~~~~~~~~~~~~~~~
  ...
  -> see $MIOS_PATH/apps/examples/lcd7/clcd_multi_8
