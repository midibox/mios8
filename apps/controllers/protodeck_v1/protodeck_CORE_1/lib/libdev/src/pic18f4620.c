 ...
 * 
 * $Id: pic18f4620.c 308 2008-05-01 17:40:20Z tk $
 *
...
volatile __FSR0H_t __at (0xFE2) FSR0Hbits;				// FSR0 and FSR1 swapped for MIOS SDCC Wrapper compatibility
...
volatile __FSR1H_t __at (0xFEA) FSR1Hbits;				// FSR0 and FSR1 swapped for MIOS SDCC Wrapper compatibility
