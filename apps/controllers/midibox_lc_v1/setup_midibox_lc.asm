...
;
; Configuration steps:
;    o check the "general application settings" below if changes are required 
;      for your hardware setup
;
;    o go through the button/led assignment table in src/lc_io_table.inc
...
;      the 128 MIDI Events which should be sent in mios_tables.inc::MIOS_MPROC_EVENT_TABLE
;
;    o optionally you can also change the lables in lc_gpc_lables.inc
;
; Optional:
;    o change the display layout in lc_glcd.inc (or lc_clcd.inc) for
;      your needs
;    o add additional display elements (requires a lot of programming skills)
;    o for graphical LCDs also the icons and fonts can be changed (required 
;      tools and steps not documented yet)
;
;
