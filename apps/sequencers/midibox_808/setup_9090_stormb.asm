...
DEFAULT_TRKINFO MACRO
	...
	db	"Bass  ",  1,  6,   1,    0	; Track 1
	db	"Snare ",  1,  5,   1,    0	; Track 2
	db	"LT    ",  1,  4,   1,    0	; Track 3
	db	"MT    ",  1,  3,   1,    0	; Track 4
	...
	db	"Ext2  ",  0,  0,   1,    0	; Track 13
	db	"Ext3  ",  0,  0,   1,    0	; Track 14
	db	"Ext4  ",  0,  0,   1,    0	; Track 15
	db	"Acc.  ",  4,  2,   1,    0	; Track 16
	ENDM
;
