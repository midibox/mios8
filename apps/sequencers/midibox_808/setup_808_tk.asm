...
DEFAULT_TRKINFO MACRO
	...
	db	"BD    ",  1,  6,   7,    0	; Track 1
	db	"SD    ",  1,  5,   7,    0	; Track 2
	db	"LT/LC ",  1,  4,   7,    0	; Track 3
	db	"MT/MC ",  1,  3,   7,    0	; Track 4
	db	"HT/HC ",  1,  2,   7,    0	; Track 5
	db	"CP    ",  1,  1,   7,    0	; Track 6
	db	"MA    ",  1,  0,   7,    0	; Track 7
	db	"RS/CL ",  4,  7,   7,    0	; Track 8
	db	"CB    ",  4,  6,   7,    0	; Track 9
	db	"CY    ",  4,  4,   7,    0	; Track 10
	db	"OH    ",  4,  3,   7,    0	; Track 11
	db	"CH    ",  4,  2,   7,    0	; Track 12
