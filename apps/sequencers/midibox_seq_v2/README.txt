...
Some precompiled setups are part of this package:
   o setup_mbseq_v2.hex        (default setup for rotary encoders)
   o setup_mbseq_vintage.hex   (default setup for pots)
...
Infos for customization:
   ...
   o do your setup in setup_mbseq_v2.asm (or copy this to a new .asm file)
