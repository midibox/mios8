...
MIOS_ENC_PIN_TABLE
	...
	;;        SR  Pin  Mode
	ENC_ENTRY  1,  2,  MIOS_ENC_MODE_DETENTED3	; Osc delay/transpose/assign #1
	ENC_ENTRY  1,  4,  MIOS_ENC_MODE_DETENTED3	; Osc attack/finetune/assign #2
	ENC_ENTRY  1,  6,  MIOS_ENC_MODE_DETENTED3	; Osc decay/portamento/assign #3

	ENC_ENTRY  2,  0,  MIOS_ENC_MODE_DETENTED3	; Osc sustain/release/assign #4
	ENC_ENTRY  2,  2,  MIOS_ENC_MODE_DETENTED3	; Osc release/pulsewidth/assign #5
	ENC_ENTRY  2,  4,  MIOS_ENC_MODE_DETENTED3	; LFO rate
	ENC_ENTRY  2,  6,  MIOS_ENC_MODE_DETENTED3	; LFO depth

	ENC_ENTRY  3,  0,  MIOS_ENC_MODE_DETENTED3	; Filter CutOff
	ENC_ENTRY  3,  2,  MIOS_ENC_MODE_DETENTED3	; Filter Resonance
	ENC_ENTRY  3,  4,  MIOS_ENC_MODE_DETENTED3	; Env depth/assign #1
	ENC_ENTRY  3,  6,  MIOS_ENC_MODE_DETENTED3	; Env attack/assign #2

	ENC_ENTRY  4,  0,  MIOS_ENC_MODE_DETENTED3	; Env decay/assign #3
	ENC_ENTRY  4,  2,  MIOS_ENC_MODE_DETENTED3	; Env sustain/assign #4
	ENC_ENTRY  4,  4,  MIOS_ENC_MODE_DETENTED3	; Env release/assign #5
